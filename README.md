...
คอร์สสอน Smith Chart จากศูนย์: บทนำ (ไม่มีหมายเลข) + **11 บทหลัก** รวม 52 หัวข้อ 105 ภาพ เนื้อหาอยู่ใน `src/engine/basics.ts` ทุกตัวเลขและทุกภาพคำนวณสดด้วย engine · บทนำเป็นหน้าแนะนำแบบไม่มีสูตร (กราฟนี้ใช้ทำอะไร จุดกลางคืออะไร ครึ่งบน/ล่าง หนึ่งจุดแทนค่าอะไร) พร้อมแผนที่ว่าเรื่องไหนอยู่บทไหนและเส้นทางการอ่านสี่แบบ · มีแบบฝึกหัดสั้น 14 ข้อคั่นระหว่างแนวคิด ตอบโดยอ่านจากกราฟ

    ...
    sections: [
      {
        ...
        lines: [
          T('จากภาพทดลอง เดิน 0.125 λ จุดหมุนหนึ่งในสี่รอบ เดิน 0.25 λ จุดหมุนครึ่งรอบ และเดิน 0.5 λ จุดกลับมาทับที่เดิม ความยาวคลื่น λ ในที่นี้คือความยาวคลื่นในสาย ณ ความถี่ที่ใช้งาน'),
          T('เหตุผลที่มีตัวคูณ 2: Γ เปรียบเทียบคลื่นสะท้อนกับคลื่นเดินหน้า เมื่อย้ายตำแหน่งวัด เฟสของสองคลื่นเปลี่ยนคนละทิศ มุมสัมพัทธ์จึงเปลี่ยนเป็นสองเท่าของมุมทางไฟฟ้าของสาย'),
          K('สูตรใช้งานเร็ว: มุมหมุนบนกราฟ = 720° × ระยะในหน่วย λ\nตัวอย่าง 0.100 λ → 720 × 0.100 = 72°\nย้อนกลับ: ต้องการหมุน 90° → ระยะ = 90/720 = 0.125 λ'),
          T('เมื่อพร้อมอ่านสูตร ให้ l เป็นระยะจริงและ β เป็นตัวแปลงระยะเป็นมุม จะเขียนความสัมพันธ์เดียวกันได้ว่า'),
          ...
          N('ตัวอย่างนี้ใช้สายสม่ำเสมอไร้การสูญเสีย อ้างอิงกราฟด้วย Z₀ ของสายนั้น ถ้าสายมีการสูญเสีย มุม Γ ยังหมุนครบหนึ่งรอบทุกครึ่งคลื่นในแบบจำลองนี้ แต่รัศมีหดลง จึงไม่กลับทับจุดเดิม ส่วนโหลดแมตช์อยู่กลางกราฟจะไม่มีมุมให้สังเกต'),
  ...
  chart: { swr: [swrApp], scale: true, fine: false,
    points: [
      ...
      },
      {
        ...
        lines: [
          T('ดูโจทย์ก่อนว่าจุดวัดกำลังเคลื่อนเข้าหาปลายไหน: generator คือเครื่องส่งหรือแหล่งจ่าย ส่วน load คือโหลดที่ปลายสาย ทิศบนกระดาษขึ้นกับรูปวงจร แต่ทิศบน Smith Chart มาตรฐานใช้กฎต่อไปนี้'),
  ...
  chart: { swr: [swrApp], scale: true, fine: false,
    points: [{ z: zApp, label: 'z_L', cls: 'load' }] },
      ...
      },
      {
        ...
        lines: [
          T('ตัวเลขรอบกราฟเป็นพิกัดเริ่มต้น ไม่ใช่ระยะจากโหลดโดยตรง เหมือนเข็มนาฬิกาที่เริ่มได้ทุกตำแหน่ง ระยะเดินคือผลต่างระหว่างพิกัดเริ่มกับพิกัดปลายตามทิศที่เลือก'),
          W('ขั้นตอนด้านล่างใช้สเกล Toward Generator ชุดเดียว: ไปทางเครื่องส่งให้บวก กลับทางโหลดให้ลบ ถ้าเลือกสเกล Toward Load แทน ค่าจะเพิ่มในทิศกลับทางโหลด อย่าสลับชุดสเกลกลางโจทย์'),
          ...
          T('ตัวอย่างข้ามปลายสเกล: เริ่ม 0.45 เดินไปทางเครื่องส่ง 0.10 λ ได้ 0.55 จึงลบ 0.5 เหลือสเกล 0.05 ระยะที่เดินจริงยังเป็น 0.10 λ'),
          M('0.45+0.10=0.55 \\;\\Rightarrow\\; 0.55-0.50=0.05'),
          T('เดินย้อนทิศ: เริ่ม 0.05 เดินกลับทางโหลด 0.10 λ ได้ −0.05 จึงบวก 0.5 กลับมาเป็นสเกล 0.45'),
          M('0.05-0.10=-0.05 \\;\\Rightarrow\\; -0.05+0.50=0.45'),
          N('ถ้าโจทย์ให้พิกัดเริ่ม 0.45 และพิกัดปลาย 0.05 ในทิศไปทางเครื่องส่ง ระยะที่สั้นที่สุดคือ (0.50−0.45)+0.05 = 0.10 λ ส่วน 0.60 λ หรือ 1.10 λ ก็จบที่พิกัดเดิมได้ ต้องใช้เงื่อนไขระยะของโจทย์ช่วยเลือก'),
        ...
        figures: [
          { kind: 'quiz', question: 'ใช้สเกล Toward Generator เริ่มที่ 0.45 เดินไปทางเครื่องส่งอีก 0.10 λ พิกัดปลายเป็นเท่าไร?',
            ...
            explain: '0.45 + 0.10 = 0.55 เกินช่วงหนึ่งรอบของสเกล จึงลบ 0.50 เหลือ 0.05 ระยะที่เดินคือ 0.10 λ ไม่ใช่ 0.05 λ' },
{ kind: 'quiz',
      ...
      },
      {
        ...
        figures: [
          ...
          { kind: 'smith', title: 'สตับเดินอยู่บนขอบกราฟเสมอ — ปลายลัดออกจาก SHORT ปลายเปิดออกจาก OPEN',
            ...
            caption: 'เส้นแดงคือสตับปลายลัด ออกเดินจาก SHORT ไปตามขอบด้านบน · เส้นเขียวคือสตับปลายเปิด ออกเดินจาก OPEN ไปตามขอบด้านล่าง · ทั้งคู่หมุนตามเข็มนาฬิกาเมื่อยาวขึ้น และอยู่บนขอบวง (|Γ| = 1) ตลอด เพราะสายไร้การสูญเสียไม่กินกำลังเลย · หัวลูกศรของทั้งสองเส้นอยู่ที่ λ/4 พอดี ซึ่งเป็นจุดที่ปลายลัดกลายเป็นเหมือนปลายเปิด และปลายเปิดกลายเป็นเหมือนปลายลัด' },
{ kind: 'quiz',
    ...
    points: [
      ...
      },
      {
        ...
        lines: [
          ...
          W(`ดูให้ดี — ส่วนจินตภาพหายไปจริง แต่ส่วนจริงยังเป็น ${n(exsYtot.re, 4)} ไม่ใช่ 1 · SWR ที่ได้จึงเป็น ${n(exsSwr, 4)} ไม่ใช่ 1 (คำนวณโดยแอป) · แปลว่าสตับตัวนี้ “หักล้างส่วนจินตภาพสำเร็จ” แต่ “ยังไม่แมตช์”`),
        ...
        figures: [
          ...
          { kind: 'smith', title: 'ขั้นที่ 5: หักล้าง b หมดแล้ว แต่ยังไม่ถึงจุดกลาง',
            ...
            caption: `จุดเขียวตรงกลางคือเป้าหมาย y = 1 · สตับพาจุดไถลไปตามวงกลม g = ${n(exsY.re, 4)} ซึ่งเป็นค่าเดิมของโหลด · ไถลจนส่วนจินตภาพเป็นศูนย์ก็สุดทางแล้ว ได้ SWR = ${n(exsSwr, 4)} (คำนวณโดยแอป) · จุดกลางอยู่บนวง g = 1 คนละวงกัน สตับตัวเดียวที่ตำแหน่งนี้จึงไปไม่ถึง` },
        ],
      },
      {
        ...
        figures: [
          ...
          { kind: 'quiz',
            ...
            chart: { scale: false, fine: false, table: false, showY: true, gCircles: [exsYtot.re, 1],
              points: [{ z: admittance(exsYtot), label: `y = ${n(exsYtot.re, 2)} + j0`, cls: 'mid' }, { z: C(1, 0), label: 'y = 1', cls: 'in' }] } },
        ],
      },
    ],
  },
